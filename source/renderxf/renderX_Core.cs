...
namespace renderX2
{
        ...
        */
        ...
        public unsafe void Draw()
        {
            ...
            lock(ThreadLock){
                ...
                if (SB.wasDisposed)
                    throw new Exception("The vertex buffer was already disposed!");
        ...
        public unsafe void BlitIntoBitmap(Bitmap TargetBitmap, Point TargetPoint, Rectangle SourceRectangle)
        {
            ...
            if (sD != 4)
                throw new Exception("24bpp not yet supported!");
    ...
    public unsafe class GLBuffer : IDisposable
    {
        ...
        public bool wasDisposed { get { return disposed; } }
        ...
        public GLBuffer(float[] SourceArray, int Stride, MemoryLocation StackOrHeap)
        {
            ...
            if (!suspectedLinearray)
                if (SourceArray.Length < Stride * 3)
                    throw new Exception("Buffer must have an entire face!");
